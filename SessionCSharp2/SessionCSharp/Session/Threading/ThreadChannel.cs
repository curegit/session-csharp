...
namespace Session.Threading
{
	...
	public static class ThreadChannel
	{
		public static S ForkThread<S, Z>(this Dual<S, Z> protocol, Action<Z> threadFunc) where S : Session, new() where Z : Session, new()
		{
			...
			var (client, server) = ChannelFactory.CreateWithSession<S, Z>();
		...
		/*
		public static Session<S, Empty, Cons<S, SS>> ForkThread<S, SS, Z, ZZ>(this Dual<Cons<S, SS>, Cons<Z, ZZ>> protocol, Action<Session<Z, Empty, Cons<Z, ZZ>>> threadFunc) where S : SessionType where SS : SessionList where Z : SessionType where ZZ : SessionList
		{
			if (protocol is null) throw new ArgumentNullException(nameof(protocol));
			if (threadFunc is null) throw new ArgumentNullException(nameof(threadFunc));
			...
			/*
		public static IEnumerable<Session<S, Empty, Cons<S, Nil>>> Parallel<S, Z>(this Dual<S, Z> protocol, int n, Action<Session<Z, Empty, Cons<Z, Nil>>> threadFunction) where S : SessionType where Z : SessionType
		{
			return Parallel<S, Nil, Z, Nil>(Arrange<S, Z>(protocol), n, threadFunction);
		}

		public static IEnumerable<Session<S, Empty, Cons<S, SS>>> Parallel<S, SS, Z, ZZ>(this Dual<Cons<S, SS>, Cons<Z, ZZ>> protocol, int n, Action<Session<Z, Empty, Cons<Z, ZZ>>> threadFunction) where S : SessionType where SS : SessionList where Z : SessionType where ZZ : SessionList
		{
		...
		public static IEnumerable<Session<S, Empty, Cons<S, Nil>>> Parallel<S, Z, T>(this Dual<S, Z> protocol, IEnumerable<T> args, Action<Session<Z, Empty, Cons<Z, Nil>>, T> threadFunction) where S : SessionType where Z : SessionType
		{
			return Parallel<S, Nil, Z, Nil, T>(Arrange(protocol), args, threadFunction);
		}

		public static IEnumerable<Session<S, Empty, Cons<S, SS>>> Parallel<S, SS, Z, ZZ, T>(this Dual<Cons<S, SS>, Cons<Z, ZZ>> protocol, IEnumerable<T> args, Action<Session<Z, Empty, Cons<Z, ZZ>>, T> threadFunction) where S : SessionType where SS : SessionList where Z : SessionType where ZZ : SessionList
		{
